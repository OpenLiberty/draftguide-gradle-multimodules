...
Default artifactID will be {pojectName}.{moduleName}.{version}.
For the current `war` project it will be `guide-gradle-multimodules.war.1.0-SNAPSHOT`.

In case you have removed `webModule` from ear/build.gradle , application URL will be http://localhost:9080/guide-gradle-multimodules.war.1.0-SNAPSHOT/[http://localhost:9080/guide-gradle-multimodules.war.1.0-SNAPSHOT/^]
